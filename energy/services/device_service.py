...
class DeviceService:
    ...
    def process_status_message(self, context: MessageContext) -> bool:
        ...
        try:
            ...
            if not device_config:
                logger.warning(f"No device config found for status topic: {context.topic}")
                return False
    ...
    def _find_device_config(self, context: MessageContext) -> Optional[DeviceConfiguration]:
        ...
        try:
            ...
            return DeviceConfiguration.objects.select_related('plant').filter(
    ...
    def _update_device_status(self, device_config: DeviceConfiguration, 
    ...
    def _determine_device_status(self, device_config: DeviceConfiguration) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {
                ...
                'plant_name': device_config.plant.name if device_config.plant else 'Unknown',
    ...
    def _cache_device_status(self, device_config: DeviceConfiguration, 
