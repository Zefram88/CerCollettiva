...
from .views.mqtt_views import mqtt_control, mqtt_settings, save_mqtt_settings
...
urlpatterns = [
    ...
    path(
        "api/plants/<int:plant_id>/mqtt-data/", plant_mqtt_data, name="plant-mqtt-data"
    ),
    path("api/plants/mqtt-data/", plant_mqtt_data, name="mqtt-data"),
    # API Dispositivi
    path(
        "api/devices/<int:pk>/latest_measurement/",
