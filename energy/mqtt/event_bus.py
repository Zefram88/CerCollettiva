...
class EventBus:
    ...
    def start(self) -> None:
        ...
        try:
            with self._lock:
                ...
                self._running = True
                logger.info("Starting EventBus with {} workers".format(self._num_workers))
    ...
    def register_handler(self, event_type: str, handler: Callable[[Event], bool]) -> None:
        """
    ...
    def unregister_handler(self, event_type: str, handler: Callable[[Event], bool]) -> bool:
        """
    ...
    def publish_event(self, event: Event) -> bool:
        ...
        try:
            ...
            if success:
                logger.debug(f"Event published: {event.event_type} for topic: {event.topic}")
            else:
    ...
    def publish_mqtt_message(self, topic: str, payload: Dict[str, Any], 
                           context: Optional[MessageContext] = None) -> bool:
        """
        ...
        try:
            ...
            if success_count > 0:
                ...
                if message.retry_count < message.max_retries:
                    ...
                    logger.warning(f"Retrying event {event_type} (attempt {message.retry_count})")
