...
class QueuedMessage:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        data["processing_completed"] = (
            self.processing_completed.isoformat() if self.processing_completed else None
        )
        ...
        while True:
            try:
                ...
                with self._lock:
                    ...
                    retry_messages = [
                        msg for msg in self._queue if msg.status == MessageStatus.RETRY
                    ]
                    ...
                    for message in retry_messages:
                        ...
                        if message.processing_started:
                            time_since_failure = (
                                timezone.now() - message.processing_started
                            )
