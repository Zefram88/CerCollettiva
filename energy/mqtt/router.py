...
class MQTTMessageRouter:
    ...
    def route_message(self, topic: str, payload: Any, qos: int = 0, 
    ...
    def _create_message_context(self, topic: str, payload: Any, 
                               qos: int, retain: bool) -> MessageContext:
    ...
    def _extract_topic_info(self, topic: str) -> tuple[Optional[str], Optional[str], Optional[str]]:
