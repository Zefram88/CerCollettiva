...
from core.main_models import CERConfiguration, CERMembership, Plant, PlantMeasurement, PlantDocument, Alert, MembershipCard, MemberRegistry, CERDistributionConfiguration, GSEIncomeTracking
...
class CERMembershipAdmin(admin.ModelAdmin):
    list_display = ['user', 'cer_configuration', 'role', 'is_active', 'document_verified', 'joined_at']
...
class PlantAdmin(admin.ModelAdmin):
    list_display = ['name', 'pod_code', 'plant_type', 'owner', 'is_active', 'created_at']
...
class MembershipCardAdmin(admin.ModelAdmin):
    list_display = ['card_number', 'membership', 'is_active', 'membership_fee_paid', 'issue_date', 'expiry_date']
...
class CustomUserAdmin(admin.ModelAdmin):
    list_display = ['username', 'email', 'first_name', 'last_name', 'fiscal_code', 'legal_type', 'profit_type', 'is_active', 'is_staff', 'date_joined']
    list_filter = ['legal_type', 'profit_type', 'is_active', 'is_staff', 'date_joined']
    search_fields = ['username', 'email', 'first_name', 'last_name', 'fiscal_code', 'vat_number']
