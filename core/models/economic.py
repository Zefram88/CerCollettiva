...
class EconomicTransaction(models.Model):
    ...
    currency = models.CharField(
        ...
        max_length=3,
        default='EUR',
        help_text="Codice valuta ISO 4217"
    )
    ...
    due_date = models.DateTimeField(
        ...
        null=True,
        blank=True,
        help_text="Data di scadenza per il pagamento"
    )
    ...
    description = models.TextField(
        "Descrizione",
        blank=True,
        help_text="Descrizione dettagliata della transazione"
    )
    notes = models.TextField(
        "Note",
        blank=True,
        help_text="Note interne"
    )
    ...
    fiscal_year = models.IntegerField(
        "Anno Fiscale",
        help_text="Anno fiscale di riferimento"
    )
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.fiscal_year:
            self.fiscal_year = self.reference_period_start.year if self.reference_period_start else timezone.now().year
    ...
    def _generate_transaction_number(self):
        ...
        count = EconomicTransaction.objects.filter(
...
class TransactionApproval(models.Model):
    ...
    expires_at = models.DateTimeField(
        "Scade il",
        help_text="Data di scadenza della richiesta di approvazione"
    )
    
    # Motivazioni
    request_reason = models.TextField(
        "Motivo Richiesta",
        help_text="Motivazione della richiesta di approvazione"
    )
    approval_notes = models.TextField(
        "Note Approvazione",
        blank=True,
        help_text="Note dell'approvatore"
    )
