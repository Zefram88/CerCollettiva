...
urlpatterns = [
    ...
    path(
        ...
        AccessibilityAuditView.as_view(),
    ...
    # A/B Testing
    path(
        "api/ab-testing/participation/",
        ABTestingParticipationView.as_view(),
        name="ab_testing_participation",
    ),
    path(
        "api/ab-testing/event/", ABTestingEventView.as_view(), name="ab_testing_event"
    ),
]
