    ...
    def get(self, request):
        ...
        response_data = {
            ...
            "database": {
                ...
                "version": (
                    connection.Database.version
                    if hasattr(connection.Database, "version")
                    else "unknown"
                ),
            },
        }
        ...
        status_code = (
            ...
            else 503 if status == HealthStatus.UNHEALTHY else 207
        )
                ...
                if hasattr(active_broker, "last_connected"):
                    if active_broker.last_connected:
                        time_since_connection = (
                            timezone.now() - active_broker.last_connected
                        )
...
class StatusView(View):
    ...
    def get(self, request):
        ...
        status_code = (
            ...
            else 503 if overall_status == HealthStatus.UNHEALTHY else 207
        )
...
class MetricsView(View):
    ...
    def get(self, request):
        ...
        return JsonResponse(
            "\n".join(metrics), safe=False, content_type="text/plain; version=0.0.4"
        )
